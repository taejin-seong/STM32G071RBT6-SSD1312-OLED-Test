 ...
 *
 */
void ssd1312_SetAddr(uint8_t page, uint8_t col)
{

  uint8_t col_low  = SSD1312_COLUMN_OFFSET_LOWER(col); // lower offset setting
  uint8_t col_high = SSD1312_COLUMN_OFFSET_HIGHER(col); // higher offset setting
